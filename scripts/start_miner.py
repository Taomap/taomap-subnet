"""
This script runs a miner process and automatically updates it when a new version is released.
Command-line arguments will be forwarded to miner (`neurons/miner.py`), so you can pass
them like this:
    python3 scripts/start_miner.py --wallet.name=my-wallet
...
miner within virtual environment, run this auto-update script from the virtual environment.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Example usage: python start_miner.py --pm2_name 'net10miner' --wallet_name 'wallet1' --wallet_hotkey 'key123'",
    )

    parser.add_argument(
        "--pm2_name", default="net10miner", help="Name of the PM2 process."
    )
